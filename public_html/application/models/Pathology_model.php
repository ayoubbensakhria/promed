...
class Pathology_model extends CI_Model {
    ...
    var $column_order = array('test_name','short_name','test_type','category_name','sub_category','method','report_days','charges.standard_charge'); //set column field database for datatable orderable
    var $column_search = array('test_name','short_name','test_type','category_name','sub_category','method','report_days','charges.standard_charge');
