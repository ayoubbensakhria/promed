                                        ...
                                        ?> </td>
                                           ...
                                           <!-- <td><?php echo $detail->charge_category; ?></td>-->
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="#" onclick="addParametervalue('<?php echo $detail->id ?>','<?php echo $detail->pathology_id ?>')" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('add') . " / " .$this->lang->line('edit') . " " . $this->lang->line('parameter') . " " . $this->lang->line('value'); ?>">
                                            ...
                                            <?php }  if ($this->rbac->hasPrivilege('pathology_print_bill','can_view')) {?>
                                            <a href="#" onclick="viewDetailbill('<?php echo $detail->id ?>','<?php echo $detail->pathology_id ?>')" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('print') . " " . $this->lang->line('bill'); ?>">
                                                    <i class="fa fa-print" aria-hidden="true"></i>
                                            </a> 
                                             <?php }
        ...
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div>   
                            <select onchange="get_PatientDetails(this.value)" disabled=""  style="width: 100%" class="form-control select2" id="addpatientid" name='' >
