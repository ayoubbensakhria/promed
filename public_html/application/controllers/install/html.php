...
<head>
    ...
    <title>PROMED DELUXE - Installation</title>
    ...
    <link href='<?php echo site_url(); ?>backend/installer_template/assets/css/open-sans.css' rel='stylesheet'
        type='text/css'>
    <link href='<?php echo site_url(); ?>backend/installer_template/assets/css/bs-overides.css' rel='stylesheet'
        type='text/css'>
    <link href='<?php echo site_url(); ?>backend/installer_template/assets/css/font-awesome.min.css' rel='stylesheet'
        type='text/css'>
...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <div class="row vcenter-item">
                <div class="col-md-12">
                    <div class="col-md-3">
                        <a href="<?php echo base_url(); ?>"><img src="../backend/images/s_logo.png" width="170"></a>
                    </div>
                </div>
                <!--./col-md-12-->
            </div>
    ...
    <div class="col-md-12 m1">
        <h2>Welcome to PROMED DELUXE HMS a Hospital Management System</h2>
        <h4>Please follow the instructions bellow to setup a new environment</h4>
            ...
            <div class="col-md-12 m1">
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="new-info-box <?php
                        ...
                        ?> padding-10">
                        <i class="fa fa-list-alt h5i new-ii"></i>
                        <h5>Requirements</h5>
                    </div>
                    <div class="new-info-box <?php
                    ...
                    <div class="new-info-box <?php
                        ...
                        ?> padding-10">
                        <i class="fa fa-download h5i new-ii"></i>
                        <h5> Install</h5>
                    </div>
                    <div class="new-info-box <?php
                        if ($step == 4) {
                ...
                <div class="col-md-9 col-sm-9">
                    <div class="newbox new-box-primary">
                        ...
                        <a href="<?php echo site_url('install/start/delete_install_dir'); ?>"
                            class="btn btn-primary">Delete Install Directory and Login to Admin Panel</a>
                        <br><br><br><br><br><br><br>
                        <p><b>Please note that in Promed DELUXE there are two login panels -</b></p>
                        <ul style="list-style: disc; margin-left: 15px;">
                            <li><span
                                    style="color: #0084B4; padding-right: 5px;"><?php echo base_url(); ?>site/login</span>
                                Admin Panel : this panel is used for staff like superadmin, admin, doctor, pharmacist,
                                pathologist, radiologist, accountant, receptionist login.</li>
                            <li><span
                                    style="color: #0084B4; padding-right: 5px;"><?php echo base_url(); ?>site/userlogin</span>
                                User Panel : this panel is used for patient login.</li>
                        </ul>
                        <?php } ?>
                    </div>
                    <!--./newbox.new-box-primary-->
