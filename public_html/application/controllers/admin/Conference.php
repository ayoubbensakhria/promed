        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($response) {
                if (isset($response->id)) {
                    ...
                    //==============
                    $sender_details = array('class_id' => $this->input->post('class_id'), 'section_id' => $this->input->post('section_id'), 'title' => $this->input->post('title'), 'meeting_date' => $this->input->post('date'), 'duration' => $this->input->post('duration'));
