        ...
        public function appointment_search()            
            {
                ...
                foreach ($resultlist as $result_key => $result_value) {                         
                    ...
                    $action.="<a href='".base_url()."admin/appointment/status/".$result_value->id."' onclick='askconfirm()'  class='btn btn-default btn-xs'  data-toggle='tooltip' title='' onclick='askconfirm()' data-original-title='".$this->lang->line('approve')." ".$this->lang->line('appointment')."'><i class='fa fa-check' aria-hidden='true'></i></a>"; 
