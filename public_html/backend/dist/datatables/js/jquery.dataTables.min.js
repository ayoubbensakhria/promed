(function (h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No data available in table <br /> <br /><img src='/backend/images/add_folder.png'><br /><br /> <span class='text-success bolds'><i class='fa fa-arrow-left'></i> Add new record or search with different criteria.</span>",
